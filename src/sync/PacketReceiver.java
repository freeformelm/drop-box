...
public class PacketReceiver extends Thread {
    ...
    private String threadName = "sync.PacketReceiver";
    ...
    public PacketReceiver(PacketBoundedBufferMonitor bm, InetAddress receiverIp, int receiverPort, InetAddress senderIp,
            int senderPort) {
